...
class GeminiModel:
    def __init__(self, model_name, temperature=0.7, max_output_tokens=1024):
        """
        ...
        try:
            ...
            print(f"Initialized GeminiModel with model {model_name} , project {self._project_id}, location {self._project_location}")
...
class GeminiJsonEngine():
    def __init__(self, model_name, basemodel, temperature, max_output_tokens, systemInstructions):
